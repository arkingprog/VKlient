...
import com.example.arkin.vkclient.adapter.DialogAdapter;
          ...
          VKRequest request=VKApi.messages().getDialogs(VKParameters.from(VKApiConst.COUNT,"20"));
            request.executeWithListener(new VKRequest.VKRequestListener() {
                ...
                public void onComplete(VKResponse response) {
                    ...
                    ListView listDialog=(ListView)findViewById(R.id.userMessages);

                    DialogAdapter dialogAdapter=new DialogAdapter(getApplicationContext(),dialogs);
